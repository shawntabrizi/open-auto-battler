    ...
    <div className="text-center">
      ...
      <div className="flex justify-center gap-6 lg:gap-10 mb-4 lg:mb-6">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-base-500 text-[10px] lg:text-xs">
            Win a battle with this card on board
          </span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-base-500 text-[10px] lg:text-xs">
            Complete a 10-win run with this card
          </span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-base-500 text-[10px] lg:text-xs">
            Perfect 10-0 run with this card
          </span>
        </div>
      </div>
      ...
      <p className="text-lg lg:text-2xl font-title font-bold text-transparent bg-clip-text theme-title-text mt-6">
        Good luck & have fun!
      </p>
    </div>
  );
