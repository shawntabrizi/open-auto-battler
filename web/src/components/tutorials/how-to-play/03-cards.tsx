    ...
    <div>
      <div className="flex flex-row items-center gap-4 lg:gap-8">
        ...
        <div className="space-y-3 lg:space-y-4 text-sm lg:text-base">
          <h2 className="text-2xl lg:text-3xl font-heading font-bold text-white">Cards</h2>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <span className="text-base-400">
                {' '}
                — the mana required to play this card onto your board.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <span className="text-base-400">
                {' '}
                — burn this card from your hand or board to gain this much mana.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex items-center gap-1 shrink-0">
              ...
              <span className="font-stat font-bold text-white text-base lg:text-lg">
                {demoCard?.attack ?? '3'}
              </span>
            </div>
            <div>
              ...
              <span className="text-base-400">
                {' '}
                — damage dealt to the front enemy unit in each clash.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <span className="text-base-400">
                {' '}
                — how much damage this unit can take before being destroyed.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <span className="text-base-400">
                {' '}
                — special effects that trigger during battle or in the shop. Read the card text
                carefully!
              </span>
            </div>
          </div>
