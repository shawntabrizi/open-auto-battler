        ...
        <div className="rounded-xl border border-warm-700/50 bg-warm-950 w-48 lg:w-64 shrink-0 aspect-video flex flex-col">
          ...
          <div className="flex-[3] flex items-center justify-center gap-1 px-2 bg-board-bg">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="flex-1 aspect-[3/4] rounded border-2 border-dashed border-warm-600/40 flex items-center justify-center"
              >
                {i > 3 && (
                  <div className="w-full h-full rounded bg-warm-800 border border-warm-600 flex items-center justify-center">
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                ...
                className={`flex-1 aspect-[3/4] rounded flex items-center justify-center ${
                  i === 2 || i === 4
                    ? 'border-2 border-dashed border-warm-600/40'
                    : 'bg-warm-800 border border-warm-600'
                }`}
              >
