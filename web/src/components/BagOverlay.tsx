...
export function BagOverlay() {
  ...
  return (
    <div className="fixed left-[11rem] lg:left-80 right-0 top-0 lg:top-16 bottom-0 lg:bottom-48 z-40 bg-black/95 lg:bg-black/90 backdrop-blur-md flex flex-col p-3 lg:p-8 overflow-hidden animate-in fade-in duration-300">
      ...
      <div className="flex-1 overflow-y-auto pr-1 lg:pr-4 custom-scrollbar">
        {bagCards.length === 0 ? (
          ...
          <div className="grid grid-cols-3 lg:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-2 lg:gap-6 pb-4 lg:pb-12">
            {bagCards.map((card, i) => {
              return (
