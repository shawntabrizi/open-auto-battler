...
export function SetSelectionScreen() {
  ...
  return (
    <div className="h-full flex items-center justify-center">
      <div className="text-center bg-warm-900 p-6 lg:p-10 rounded-2xl lg:rounded-3xl border border-white/5 shadow-2xl w-full max-w-md lg:max-w-lg">
        ...
        <p className="text-warm-500 text-sm mb-6 lg:mb-8">
        ...
        {setMetas.length > 0 ? (
          <div className="flex flex-col gap-4 max-w-sm mx-auto">
            ...
            <button
              ...
              className="bg-yellow-500 hover:bg-yellow-400 text-warm-950 font-black px-8 py-3 rounded-full text-sm transition-all transform hover:scale-105 shadow-lg shadow-yellow-500/20"
            >
              PLAY
            </button>
          </div>
        ...
        <Link
          to="/"
          className="inline-block mt-6 text-sm text-warm-500 hover:text-warm-300 transition-colors"
        >
