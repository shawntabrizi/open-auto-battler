    ...
    <div className="app-shell fixed inset-0 text-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="w-full max-w-sm lg:max-w-md mx-auto p-3 lg:p-4 lg:mt-[15vh]">
          <div className="theme-panel flex flex-col items-center justify-center py-16 lg:py-24 gap-4 rounded-2xl border border-base-700 bg-base-900/30">
            ...
            <h2 className="font-heading text-lg lg:text-xl text-base-400 tracking-wide">
              Coming Soon
            </h2>
            <p className="text-base-600 text-xs lg:text-sm text-center max-w-xs">
