...
const MENU_BUTTONS = [
  {
    ...
    gradient: 'from-accent/10 to-surface-dark/10',
    border: 'border-accent/40 hover:border-accent hover:shadow-elevation-hover',
  },
  {
    to: '/cards',
    label: 'Cards',
    description: 'Card Sandbox',
    gradient: 'from-special/10 to-surface-dark/10',
    border: 'border-special/40 hover:border-special hover:shadow-elevation-hover',
  },
  {
    to: '/customize',
    label: 'Customize',
    description: 'Art, backgrounds & avatars',
    gradient: 'from-positive/10 to-surface-dark/10',
    border: 'border-positive/40 hover:border-positive hover:shadow-elevation-hover',
  },
  {
    to: '/history',
    label: 'History',
    description: 'Achievements & stats',
    gradient: 'from-mana/10 to-surface-dark/10',
    border: 'border-mana/40 hover:border-mana hover:shadow-elevation-hover',
  },
];
