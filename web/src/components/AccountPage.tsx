  ...
  return (
    <div className="fixed inset-0 bg-warm-950 text-white overflow-y-auto">
      <div className="w-full max-w-sm lg:max-w-md mx-auto p-3 lg:p-4 lg:mt-[10vh]">
        <PageHeader backTo="/" backLabel="Menu" title="Account" />
            ...
            <section className="p-4 rounded-xl border border-warm-700 bg-warm-900/30">
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <div className="text-[10px] text-warm-600 uppercase tracking-wider">Nonce</div>
                  ...
                  <div>
                    <div className="text-[10px] text-warm-600 uppercase tracking-wider">Frozen</div>
