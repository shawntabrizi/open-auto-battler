...
export const CARD_SIZES = {
  ...
  standard: {
    tw: 'w-36 h-48 lg:w-36 lg:h-52',
    widthTw: 'w-36 lg:w-36',
  },
...
export const CARD_TEXT = {
  standard: {
    ...
    badge: 'w-6 h-7 lg:w-8 lg:h-10 text-[0.6rem] lg:text-sm',
    statIcon: 'w-3.5 h-3.5 lg:w-4 lg:h-4',
    abilityBadge: 'w-4 h-4 lg:w-5 lg:h-5',
  },
  compact: {
    title: 'text-[0.6rem] lg:text-xs',
    stat: 'text-[0.65rem] lg:text-sm',
    badge: 'w-5 h-[1.375rem] lg:w-6 lg:h-7 text-[0.55rem] lg:text-xs',
  ...
  battle: {
    ...
    stat: 'text-xs lg:text-base',
    badge: 'w-5 h-[1.375rem] lg:w-7 lg:h-9 text-[0.55rem] lg:text-sm',
