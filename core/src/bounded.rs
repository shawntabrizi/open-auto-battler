...
use crate::types::{
    AbilityCondition, AbilityTarget, AbilityTrigger, CardId, CommitTurnAction, EconomyStats,
    UnitCard, UnitStats, AbilityEffect, Ability, BoardUnit,
};
    ...
    MaxStringLen: Get<u32>,
{
    ...
    SpawnUnit { template_id: BoundedVec<u8, MaxStringLen> },
...
impl<MaxStringLen: Get<u32>> Clone for BoundedAbilityEffect<MaxStringLen> {
    fn clone(&self) -> Self {
        match self {
            Self::Damage { amount, target } => Self::Damage { amount: *amount, target: target.clone() },
            Self::ModifyStats { health, attack, target } => Self::ModifyStats {
                health: *health,
                attack: *attack,
                target: target.clone(),
            },
            Self::SpawnUnit { template_id } => Self::SpawnUnit { template_id: template_id.clone() },
            Self::Destroy { target } => Self::Destroy { target: target.clone() },
        }
    }
}
...
impl<MaxStringLen: Get<u32>> PartialEq for BoundedAbilityEffect<MaxStringLen> {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            (Self::Damage { amount: a1, target: t1 }, Self::Damage { amount: a2, target: t2 }) => a1 == a2 && t1 == t2,
            (Self::ModifyStats { health: h1, attack: at1, target: t1 }, Self::ModifyStats { health: h2, attack: at2, target: t2 }) => h1 == h2 && at1 == at2 && t1 == t2,
            (Self::SpawnUnit { template_id: id1 }, Self::SpawnUnit { template_id: id2 }) => id1 == id2,
...
impl<MaxStringLen: Get<u32>> Debug for BoundedAbilityEffect<MaxStringLen> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::Damage { amount, target } => f.debug_struct("Damage").field("amount", amount).field("target", target).finish(),
            Self::ModifyStats { health, attack, target } => f.debug_struct("ModifyStats").field("health", health).field("attack", attack).field("target", target).finish(),
            Self::SpawnUnit { template_id } => f.debug_struct("SpawnUnit").field("template_id", template_id).finish(),
    ...
    fn from(effect: AbilityEffect) -> Self {
        match effect {
            ...
            AbilityEffect::ModifyStats { health, attack, target } => {
                Self::ModifyStats { health, attack, target }
            }
...
impl<MaxStringLen: Get<u32>> From<BoundedAbilityEffect<MaxStringLen>> for AbilityEffect {
    fn from(bounded: BoundedAbilityEffect<MaxStringLen>) -> Self {
        match bounded {
            BoundedAbilityEffect::Damage { amount, target } => AbilityEffect::Damage { amount, target },
            BoundedAbilityEffect::ModifyStats { health, attack, target } => {
                AbilityEffect::ModifyStats { health, attack, target }
            }
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Clone for BoundedUnitCard<MaxAbilities, MaxStringLen> {
    fn clone(&self) -> Self {
        Self {
            id: self.id,
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> PartialEq for BoundedUnitCard<MaxAbilities, MaxStringLen> {
    fn eq(&self, other: &Self) -> bool {
        self.id == other.id &&
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Eq for BoundedUnitCard<MaxAbilities, MaxStringLen> {}

impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Debug for BoundedUnitCard<MaxAbilities, MaxStringLen> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Clone for BoundedBoardUnit<MaxAbilities, MaxStringLen> {
    fn clone(&self) -> Self {
        Self {
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> PartialEq for BoundedBoardUnit<MaxAbilities, MaxStringLen> {
    fn eq(&self, other: &Self) -> bool {
        self.card == other.card && self.current_health == other.current_health
    }
}

impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Eq for BoundedBoardUnit<MaxAbilities, MaxStringLen> {}

impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Debug for BoundedBoardUnit<MaxAbilities, MaxStringLen> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl<MaxBagSize: Get<u32>, MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Clone
...
impl<MaxBagSize: Get<u32>, MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> PartialEq
    for BoundedGameState<MaxBagSize, MaxBoardSize, MaxAbilities, MaxStringLen>
{
    fn eq(&self, other: &Self) -> bool {
        self.bag == other.bag &&
...
impl<MaxBagSize: Get<u32>, MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Eq
    for BoundedGameState<MaxBagSize, MaxBoardSize, MaxAbilities, MaxStringLen> {}

impl<MaxBagSize: Get<u32>, MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Debug
    for BoundedGameState<MaxBagSize, MaxBoardSize, MaxAbilities, MaxStringLen>
{
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    MaxStringLen: Get<u32>,
{
    fn from(state: GameState) -> Self {
        Self {
            ...
            board: BoundedVec::truncate_from(state.board.into_iter().map(|opt| opt.map(Into::into)).collect()),
...
where
    ...
    MaxStringLen: Get<u32>,
{
    fn from(bounded: BoundedGameState<MaxBagSize, MaxBoardSize, MaxAbilities, MaxStringLen>) -> Self {
        Self {
            bag: bounded.bag.into_inner().into_iter().map(Into::into).collect(),
            board: bounded
                .board
                .into_inner()
                .into_iter()
...
impl<MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>, MaxHandActions: Get<u32>> Clone
...
impl<MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>, MaxHandActions: Get<u32>> PartialEq
    for BoundedCommitTurnAction<MaxBoardSize, MaxAbilities, MaxStringLen, MaxHandActions>
{
    fn eq(&self, other: &Self) -> bool {
...
impl<MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>, MaxHandActions: Get<u32>> Eq
    for BoundedCommitTurnAction<MaxBoardSize, MaxAbilities, MaxStringLen, MaxHandActions> {}

impl<MaxBoardSize: Get<u32>, MaxAbilities: Get<u32>, MaxStringLen: Get<u32>, MaxHandActions: Get<u32>> Debug
    for BoundedCommitTurnAction<MaxBoardSize, MaxAbilities, MaxStringLen, MaxHandActions>
{
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    fn from(action: CommitTurnAction) -> Self {
        Self {
            new_board: BoundedVec::truncate_from(
                action.new_board.into_iter().map(|opt| opt.map(Into::into)).collect(),
            ),
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Clone for BoundedUnitView<MaxAbilities, MaxStringLen> {
    fn clone(&self) -> Self {
        Self {
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> PartialEq for BoundedUnitView<MaxAbilities, MaxStringLen> {
    fn eq(&self, other: &Self) -> bool {
...
impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Eq for BoundedUnitView<MaxAbilities, MaxStringLen> {}

impl<MaxAbilities: Get<u32>, MaxStringLen: Get<u32>> Debug for BoundedUnitView<MaxAbilities, MaxStringLen> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    ...
    for BoundedCombatEvent<MaxAbilities, MaxStringLen, MaxBoardSize>
{
    fn clone(&self) -> Self {
        match self {
            ...
            Self::AbilityTrigger { source_instance_id, ability_name } => Self::AbilityTrigger {
                source_instance_id: *source_instance_id,
                ability_name: ability_name.clone(),
            },
            Self::Clash { p_dmg, e_dmg } => Self::Clash { p_dmg: *p_dmg, e_dmg: *e_dmg },
            Self::DamageTaken { target_instance_id, team, remaining_hp } => Self::DamageTaken {
                target_instance_id: *target_instance_id,
                team: *team,
                remaining_hp: *remaining_hp,
            },
            Self::UnitDeath { team, new_board_state } => Self::UnitDeath {
                team: *team,
                new_board_state: new_board_state.clone(),
            },
            Self::BattleEnd { result } => Self::BattleEnd { result: result.clone() },
            Self::AbilityDamage { source_instance_id, target_instance_id, damage, remaining_hp } => Self::AbilityDamage {
                source_instance_id: *source_instance_id,
                target_instance_id: *target_instance_id,
                damage: *damage,
                remaining_hp: *remaining_hp,
            },
            Self::AbilityModifyStats { source_instance_id, target_instance_id, health_change, attack_change, new_attack, new_health } => Self::AbilityModifyStats {
                source_instance_id: *source_instance_id,
                target_instance_id: *target_instance_id,
            ...
            Self::UnitSpawn { team, spawned_unit, new_board_state } => Self::UnitSpawn {
                team: *team,
                spawned_unit: spawned_unit.clone(),
                new_board_state: new_board_state.clone(),
            },
            Self::LimitExceeded { losing_team, reason } => Self::LimitExceeded {
    ...
    for BoundedCombatEvent<MaxAbilities, MaxStringLen, MaxBoardSize>
{
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Self::AbilityTrigger { source_instance_id: s1, ability_name: n1 }, Self::AbilityTrigger { source_instance_id: s2, ability_name: n2 }) => s1 == s2 && n1 == n2,
            (Self::Clash { p_dmg: p1, e_dmg: e1 }, Self::Clash { p_dmg: p2, e_dmg: e2 }) => p1 == p2 && e1 == e2,
            (Self::DamageTaken { target_instance_id: t1, team: tm1, remaining_hp: r1 }, Self::DamageTaken { target_instance_id: t2, team: tm2, remaining_hp: r2 }) => t1 == t2 && tm1 == tm2 && r1 == r2,
            (Self::UnitDeath { team: tm1, new_board_state: b1 }, Self::UnitDeath { team: tm2, new_board_state: b2 }) => tm1 == tm2 && b1 == b2,
            (Self::BattleEnd { result: r1 }, Self::BattleEnd { result: r2 }) => r1 == r2,
            (Self::AbilityDamage { source_instance_id: s1, target_instance_id: t1, damage: d1, remaining_hp: r1 }, Self::AbilityDamage { source_instance_id: s2, target_instance_id: t2, damage: d2, remaining_hp: r2 }) => s1 == s2 && t1 == t2 && d1 == d2 && r1 == r2,
            (Self::AbilityModifyStats { source_instance_id: s1, target_instance_id: t1, health_change: h1, attack_change: a1, new_attack: na1, new_health: nh1 }, Self::AbilityModifyStats { source_instance_id: s2, target_instance_id: t2, health_change: h2, attack_change: a2, new_attack: na2, new_health: nh2 }) => s1 == s2 && t1 == t2 && h1 == h2 && a1 == a2 && na1 == na2 && nh1 == nh2,
            (Self::UnitSpawn { team: tm1, spawned_unit: s1, new_board_state: b1 }, Self::UnitSpawn { team: tm2, spawned_unit: s2, new_board_state: b2 }) => tm1 == tm2 && s1 == s2 && b1 == b2,
            (Self::LimitExceeded { losing_team: l1, reason: r1 }, Self::LimitExceeded { losing_team: l2, reason: r2 }) => l1 == l2 && r1 == r2,
            _ => false,
        }
    }
}
    ...
    for BoundedCombatEvent<MaxAbilities, MaxStringLen, MaxBoardSize>
{
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::PhaseStart { phase } => f.debug_struct("PhaseStart").field("phase", phase).finish(),
            Self::PhaseEnd { phase } => f.debug_struct("PhaseEnd").field("phase", phase).finish(),
            Self::AbilityTrigger { source_instance_id, ability_name } => f.debug_struct("AbilityTrigger").field("source_instance_id", source_instance_id).field("ability_name", ability_name).finish(),
            Self::Clash { p_dmg, e_dmg } => f.debug_struct("Clash").field("p_dmg", p_dmg).field("e_dmg", e_dmg).finish(),
            Self::DamageTaken { target_instance_id, team, remaining_hp } => f.debug_struct("DamageTaken").field("target_instance_id", target_instance_id).field("team", team).field("remaining_hp", remaining_hp).finish(),
            Self::UnitDeath { team, new_board_state } => f.debug_struct("UnitDeath").field("team", team).field("new_board_state", new_board_state).finish(),
            Self::BattleEnd { result } => f.debug_struct("BattleEnd").field("result", result).finish(),
            Self::AbilityDamage { source_instance_id, target_instance_id, damage, remaining_hp } => f.debug_struct("AbilityDamage").field("source_instance_id", source_instance_id).field("target_instance_id", target_instance_id).field("damage", damage).field("remaining_hp", remaining_hp).finish(),
            Self::AbilityModifyStats { source_instance_id, target_instance_id, health_change, attack_change, new_attack, new_health } => f.debug_struct("AbilityModifyStats").field("source_instance_id", source_instance_id).field("target_instance_id", target_instance_id).field("health_change", health_change).field("attack_change", attack_change).field("new_attack", new_attack).field("new_health", new_health).finish(),
            Self::UnitSpawn { team, spawned_unit, new_board_state } => f.debug_struct("UnitSpawn").field("team", team).field("spawned_unit", spawned_unit).field("new_board_state", new_board_state).finish(),
            Self::LimitExceeded { losing_team, reason } => f.debug_struct("LimitExceeded").field("losing_team", losing_team).field("reason", reason).finish(),
        }
    }
}
    ...
    MaxBoardSize: Get<u32>,
{
    fn from(event: crate::battle::CombatEvent) -> Self {
        match event {
            ...
            crate::battle::CombatEvent::AbilityTrigger { source_instance_id, ability_name } => {
                Self::AbilityTrigger {
                    source_instance_id,
            ...
            crate::battle::CombatEvent::DamageTaken { target_instance_id, team, remaining_hp } => {
                Self::DamageTaken { target_instance_id, team, remaining_hp }
            }
            crate::battle::CombatEvent::UnitDeath { team, new_board_state } => Self::UnitDeath {
                team,
            ...
            crate::battle::CombatEvent::AbilityDamage { source_instance_id, target_instance_id, damage, remaining_hp } => {
                Self::AbilityDamage { source_instance_id, target_instance_id, damage, remaining_hp }
            }
            crate::battle::CombatEvent::AbilityModifyStats { source_instance_id, target_instance_id, health_change, attack_change, new_attack, new_health } => {
                Self::AbilityModifyStats { source_instance_id, target_instance_id, health_change, attack_change, new_attack, new_health }
            }
            crate::battle::CombatEvent::UnitSpawn { team, spawned_unit, new_board_state } => {
                Self::UnitSpawn {
                    team,
            ...
            crate::battle::CombatEvent::LimitExceeded { losing_team, reason } => {
                Self::LimitExceeded { losing_team, reason }
            }
        }
    }
}
